...
const InterviewModal = ({ isOpen, onClose, onConfirm, application, initialDetails = null, title = 'Schedule Interview', confirmLabel = 'Confirm Interview' }) => {
    ...
    useEffect(() => {
        ...
        setFormData({
            date: initialDetails?.date ? String(initialDetails.date).slice(0, 10) : '',
                ...
                >
                    <div className="p-6 lg:p-12">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                <h2 className="text-3xl font-black text-slate-900 tracking-tight italic uppercase">{title}</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-900 ml-1">Instructions (Optional)</label>
                                <div className="relative group">
