  ...
  return (
    <div className={`relative w-full ${className}`.trim()}>
      <div className="relative flex items-center">
        {icon && (
          <svg className="absolute left-3 w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
        ...
        {value && (
          <button
            onClick={handleClear}
            className="absolute right-3 text-gray-400 hover:text-gray-600 transition duration-300"
          >
