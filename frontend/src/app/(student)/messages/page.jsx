...
/**
 * Student Messages — lists conversations from the student's applications,
 * allows viewing and sending messages to employers.
 */
const StudentMessagesPage = () => {
    ...
    /** Fetch this student's applications to build the conversation list. */
    ...
    /** Send a new message to the employer. */
    const sendMessage = async (e) => {
        ...
        try {
            const token = Cookies.get('token') || localStorage.getItem('token');
            // The receiver is the employer who posted the internship
    ...
    /** Get a display name for the employer in a conversation. */
    const getEmployerName = (app) => {
        return app.employer?.companyName
    ...
    return (
        <div className="h-[calc(100vh-2rem)] flex flex-col p-4 lg:p-8">
            {/* Header */}
            <div className="flex items-center gap-4 mb-4">
                <button onClick={() => router.push('/student-dashboard')} className="w-9 h-9 flex items-center justify-center rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-600 transition-all">
                    <ArrowLeft className="w-4 h-4" />
                </button>
                <div>
                    <h1 className="text-2xl font-black text-gray-900">Messages</h1>
                    <p className="text-sm text-gray-500">Communicate with employers about your applications</p>
                </div>
            </div>
                    ...
                    <div className="flex-1 overflow-y-auto">
                        {loading ? (
                            ...
                            applications.map((app) => {
                                const employerName = getEmployerName(app);
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <Avatar
                                                src={`https://api.dicebear.com/7.x/initials/svg?seed=${employerName}`}
                    ...
                    {!selectedApp ? (
                        ...
                        <>
                            ...
                            <div className="p-4 border-b border-gray-100 flex items-center gap-3 bg-gray-50/50">
                                <Avatar
                                    src={`https://api.dicebear.com/7.x/initials/svg?seed=${getEmployerName(selectedApp)}`}
