                            ...
                            <AnimatePresence>
                                {status === 'error' && (
                                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="bg-red-50 text-red-600 p-3 rounded-xl border border-red-100 text-sm flex items-center">
                                        <AlertCircle size={16} className="mr-2 flex-shrink-0" /> {serverMessage}
                                    </motion.div>
                                )}
                            </AnimatePresence>
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-10 pr-4 py-3.5 bg-gray-50 border rounded-2xl focus:outline-none focus:ring-2 focus:bg-white transition-all shadow-sm ${errors.password ? 'border-red-500 focus:ring-red-500/50' : 'border-transparent focus:ring-indigo-500/50'}`}
                                        placeholder="••••••••"
                                    />
                                </div>
                                <AnimatePresence>
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className={`w-full pl-10 pr-4 py-3.5 bg-gray-50 border rounded-2xl focus:outline-none focus:ring-2 focus:bg-white transition-all shadow-sm ${errors.confirmPassword ? 'border-red-500 focus:ring-red-500/50' : 'border-transparent focus:ring-indigo-500/50'}`}
                                        placeholder="••••••••"
                                    />
                                </div>
                                <AnimatePresence>
