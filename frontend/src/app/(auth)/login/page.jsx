            ...
            >
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 bg-white/50">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <a href={`${API_URL}/api/v1/auth/google`} className="flex justify-center items-center py-2.5 px-4 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-colors shadow-sm hover:shadow text-sm font-medium text-gray-700">
                        ...
                        <a href={`${API_URL}/api/v1/auth/linkedin`} className="flex justify-center items-center py-2.5 px-4 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-colors shadow-sm hover:shadow text-sm font-medium text-gray-700">
