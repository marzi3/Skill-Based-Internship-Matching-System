            ...
            >
                ...
                <div className="w-full md:w-7/12 p-10 md:p-14">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <a href={`${API_URL}/api/v1/auth/google?role=${role}`} className="flex justify-center items-center py-2.5 px-4 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700">
                        ...
                        <a href={`${API_URL}/api/v1/auth/linkedin?role=${role}`} className="flex justify-center items-center py-2.5 px-4 border border-gray-200 rounded-xl bg-white hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700">
